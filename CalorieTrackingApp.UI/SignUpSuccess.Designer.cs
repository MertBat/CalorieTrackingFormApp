namespace CalorieTrackingApp.UI
{
    partial class SignUpSuccess
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTargetCalorieDifference = new Label();
            label15 = new Label();
            lblTargetWater = new Label();
            label11 = new Label();
            lblTargetCalorie = new Label();
            label7 = new Label();
            lblStandartCalorie = new Label();
            label13 = new Label();
            lblRemainingOnTarget = new Label();
            label5 = new Label();
            ...
            groupBox1.Location = new Point(619, 9);
            groupBox1.Name = "groupBox1";
            groupBox1.Size = new Size(508, 763);
            ...
            label16.Location = new Point(100, 220);
            label16.Name = "label16";
            label16.Size = new Size(313, 24);
            label16.TabIndex = 54;
            label16.Text = "Kaydın başarı ile tamamlandı.";
            // 
            // groupBox2
            // 
            groupBox2.Controls.Add(lblTargetCalorieDifference);
            groupBox2.Controls.Add(label15);
            groupBox2.Controls.Add(lblTargetWater);
            groupBox2.Controls.Add(label11);
            groupBox2.Controls.Add(lblTargetCalorie);
            groupBox2.Controls.Add(label7);
            groupBox2.Controls.Add(lblStandartCalorie);
            groupBox2.Controls.Add(label13);
            groupBox2.Controls.Add(lblRemainingOnTarget);
            groupBox2.Controls.Add(label5);
            groupBox2.Controls.Add(lblTargetWeight);
            ...
            groupBox2.Text = "Hesaplanan Değerler";
            ...
            lblTargetWater.Location = new Point(77, 325);
            ...
            label11.Location = new Point(31, 288);
            ...
            lblTargetCalorie.Location = new Point(265, 204);
            ...
            label7.Location = new Point(270, 169);
            label7.Name = "label7";
            ...
            lblStandartCalorie.Location = new Point(48, 204);
            ...
            lblRemainingOnTarget.Location = new Point(303, 94);
            ...
            lblRemainingOnTarget.Click += label4_Click;
            // 
            // label5
            // 
            ...
            lblTargetWeight.Location = new Point(156, 94);
            ...
            label3.Location = new Point(138, 59);
            label3.Name = "label3";
            ...
            lblBMI.Location = new Point(37, 94);
            lblBMI.Name = "lblBMI";
            ...
            label8.Location = new Point(48, 59);
            label8.Name = "label8";
            ...
            btnLoginScreen.Text = "Giriş Ekranına Git";
        ...
        private Label lblRemainingOnTarget;
        private Label label5;
        private Label lblTargetWeight;
        private Label label3;
        private Label lblBMI;
        private Label label8;
        private Label lblTargetWater;
        private Label label11;
        private Label lblTargetCalorie;
        private Label label7;
        private Label lblStandartCalorie;
        private Label label13;
        private Label lblTargetCalorieDifference;
